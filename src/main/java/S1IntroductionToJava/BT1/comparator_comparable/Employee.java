...
public class Employee implements Comparable<Employee> {
    //comparable là so sánh (name, age, salary) trong Employee
    private String name;
    private int age;
    ...
    public boolean equals(Object obj) {
        //equals : so sánh (vì ko so sánh bằng được nên sài equals)
        if (this == obj) {
            return true;
        }
    ...
    //hashcode : băm nhỏ mã (mỗi mã thì có 1 số định danh riêng biệt)
